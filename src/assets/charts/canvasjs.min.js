...
(function () {
        ...
        return (M = N.replace(h, function (l) {
          switch (l) {
            ...
            case "K":
              return S
                ? "UTC"
                : (String(E).match(x) || [""]).pop().replace(F, "");
            case "z":
  ...
  ba.prototype.updateOption = function (h) {
    ...
    this.themeOptions = w;
    h in m &&
      (x = h in this.options ? this.options[h] : w && h in w ? w[h] : m[h]);
  ...
  ya.prototype.setLayout = function () {
    if (this.text) {
      ...
      "top" === this.verticalAlign || "bottom" === this.verticalAlign
        ? (null === this.maxWidth &&
            (this.maxWidth =
              m.width - 4 - F * ("center" === this.horizontalAlign ? 2 : 1)),
  ...
  x = Pa.Chart = (function () {
          ...
          if ("normal" === this.plotInfo.axisPlacement) {
            ...
            "inside" !== y
              ? ((e = c.y1),
                ...
                0 < v
                  ? ((g =
                      n.point.y + ("horizontal" === C ? s / 2 : 0) - k - t - b),
                    g < e &&
                      ((g =
                        "auto" === y
              ...
              "inside" !== y
                ? ((e = c.x1),
                  ...
                  0 > v
                    ? ((q =
                        n.point.x -
                        ("horizontal" === C ? B : B - s / 2) -
                        l -
                        b),
                      q < e &&
                        ((q =
                          "auto" === y ? Math.max(n.point.x, e) + l : e + l),
                        (x = q + B > n.point.x)))
                    : ((q =
                        n.point.x + ("horizontal" === C ? 0 : s / 2) + l + b),
                      q > f - B - l - b &&
                        ((q =
                          "auto" === y
                ...
                if ("number" !== typeof n[m].y)
                  ...
                  m < n.length - 1 &&
                    ...
                    b.setLineDash &&
                      (n[m].lineDashType
                        ? ((p = n[m].lineDashType),
                          (y[y.length - 1].newLineDashArray = N(
                            p,
                            k.lineThickness
                          )))
                        : ((p = k.lineDashType),
    ...
    m.prototype.renderStackedColumn100 = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var s = 0; s < a.dataSeriesIndexes.length; s++) {
          ...
          if (0 < u.length)
            for (
              var r = 5 < g && m.bevelEnabled ? !0 : !1, k = 0;
              k < u.length;
              k++
            )
              if (
                ...
                if (
                  ...
                  p -= A;
                  D = q - A;
                  a.dataSeriesIndexes.length - 1 === s &&
                    1 >= Math.abs(e.y1 - p) &&
                    (p = e.y1);
                  f[b] = A + (D - p);
                } else
            ...
            for (s = !1; q < p.length; q++)
              if (
                ...
                if ("number" !== typeof p[q].y)
                    ...
                    (n.connectNullData
                      ? b.setLineDash &&
                        ...
                        (n.options.nullDataLineDashType ||
                          !p[q - 1].lineDashType) &&
                        ((r[r.length - 1].newLineDashArray = x),
                  ...
                  q < p.length - 1 &&
                    (D !== (p[q].lineColor || C) ||
                      A !== (p[q].lineDashType || n.lineDashType)) &&
                    ((D = p[q].lineColor || C),
                  ...
                  : ((m = a.axisX.convertValueToPixel(r)),
                    ...
                    h < s.length - 1 &&
                      ...
                      f.setLineDash &&
                        (s[h].lineDashType
                          ? ((R = s[h].lineDashType),
                            f.setLineDash(N(R, g.lineThickness)))
            ...
            for (var Y = !0, q = 0; q < n.length; q++) {
              ...
              if (
                ...
                if ("number" !== typeof fa.y)
                  ...
                  q < v.length - 1 &&
                    (R !== (v[q].lineColor || x) ||
                      y !== (v[q].lineDashType || A.lineDashType)) &&
                    (d(),
                    b.beginPath(),
                    b.moveTo(g, s),
                    k.push({ x: g, y: m - la }),
                    ...
                    b.setLineDash &&
                      (v[q].lineDashType
                        ? ((y = v[q].lineDashType),
                          b.setLineDash(N(y, A.lineThickness)))
            ...
            for (var Y = !0, q = 0; q < n.length; q++) {
              ...
              if (
                ...
                if ("number" !== typeof fa.y)
                  ...
                  q < v.length - 1 &&
                    (R !== (v[q].lineColor || x) ||
                      u !== (v[q].lineDashType || A.lineDashType)) &&
                    (d(),
                    b.beginPath(),
                    b.moveTo(g, s),
                    k.push({ x: g, y: z - E }),
    ...
    m.prototype.renderCandlestick = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
          ...
          if (0 < z.length)
            for (
              var y = 5 < s && u.bevelEnabled ? !0 : !1, t = 0;
              t < z.length;
              t++
            )
              if (
    ...
    m.prototype.renderBoxAndWhisker = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (
          ...
          if (0 < y.length)
            for (
              var C = 5 < s && z.bevelEnabled ? !0 : !1, l = 0;
              l < y.length;
              l++
            )
              if (
              ...
              var e = (C.lineColor = C.options.color ? C.options.color : E[0]),
                R = {
                  color: D[t].whiskerColor
                    ...
                    ? C.whiskerColor
                    : e,
                  thickness: r(D[t].whiskerThickness)
                    ? C.whiskerThickness
                  ...
                  length: r(D[t].whiskerLength)
                    ...
                    : D[t].whiskerLength,
                  trimLength: r(D[t].whiskerLength)
                    ? r(C.options.whiskerLength)
                      ? 50
                      : 0
                    : 0,
            ...
            for (var R = !0; g < p.length; g++)
              if (
                ...
                if (
                  ...
                  g < p.length - 1 &&
                    (D !== (p[g].lineColor || v) ||
                      A !== (p[g].lineDashType || n.lineDashType)) &&
                    (d(),
                    (D = p[g].lineColor || v),
            ...
            for (g = !1; p < n.length; p++)
              if (
                ...
                if (
                  ...
                  p < n.length - 1 &&
                    (y !== (n[p].lineColor || z) ||
                      C !== (n[p].lineDashType || k.lineDashType)) &&
                    ((y = n[p].lineColor || z),
    ...
    m.prototype.renderFunnel = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        if (0 != u.length && u.dataPoints && u.visible && 0 !== z.length) {
          ...
          if (-1 !== H) {
            if (u.reversed)
              for (E.push(Z), G = H.length - 1; 0 < G; G--)
                (Z += H[G]), E.push(Z);
            ...
            for (G = 0; G < z.length; G++)
              z[G].exploded &&
                ((H = !0), u.reversed ? W.push(z.length - 1 - G) : W.push(G));
            ...
            for (G = 0; G < O.length; G++)
              (A = O[G]), oa(T, A, u.fillOpacity), ga.push(A.y1);
            v(T);
            J &&
              u.visible &&
            ...
            for (g = 0; g < a.length; g++) {
              ...
              if (b && 0 < b.length)
                for (L = 0; L < b.length; L++)
                  b[L] &&
                    b[L].labelAutoFit &&
                    ((m = b[L].lineCoordinates.x1), (l = m - X));
              a[g].lineCoordinates = {
                x1: m - P,
                y1: h,
                x2: m - P,
            ...
            for (g = 0; g < d.length; g++) {
              ...
              if (b && 0 < b.length)
                for (L = 0; L < b.length; L++)
                  b[L] &&
                    b[L].labelAutoFit &&
                    ((m = b[L].lineCoordinates.x2), (l = m - U));
              d[g].lineCoordinates = {
                x1: m + Q,
                y1: h,
                x2: m + Q,
            ...
            (b / 1 <= a
              ...
              : ((this.interval =
                  b / (1 * T.yearDuration) <= a
                    ...
                    ? 4
                    : Math.floor(
                        F.getNiceNumber(b / (a - 1), !0) / T.yearDuration
                      )),
    ...
    F.prototype.calculateLogarithmicAxisParameters = function () {
      ...
      l = Math.pow(
        this.logarithmBase,
        F.getNiceNumber(Math.abs(Math.log(l) / d), !1)
      );
      this.options && 0 < this.options.interval
      ...
      1 === this.viewportMaximum &&
        ...
        this.options &&
          "undefined" === typeof this.options.interval &&
          ((this.interval = F.getNiceExponent(
            ...
            p =
              "xySwapped" === this.chart.plotInfo.axisPlacement
                ...
                : Math.floor(
                  ...
                  (5 > this.parent.range ? 2 : 10 > this.parent.range ? 1 : 0);
          this.valueFormatString = F.generateValueFormatString(
            this.parent.range,
            p
          );
        }
        ...
        if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
            ...
            for (
              ...
              if (n[s].dataPoint.y && n[s].dataPoint.y.length)
                for (var z = 0; z < n[s].dataPoint.y.length; z++)
                  (u = Math.abs(
                    a - this.parent.convertValueToPixel(n[s].dataPoint.y[z])
                  )),
                    u < v && ((v = u), (x = s));
              else
                (u = Math.abs(
          ...
          if (
            ...
            if (
              ...
              v = Math.abs(
                a - this.parent.convertValueToPixel(z.dataPoint.y[0])
              );
              for (s = u = 0; s < z.dataPoint.y.length; s++)
                (u = Math.abs(
                  a - this.parent.convertValueToPixel(z.dataPoint.y[s])
                )),
                  u < v && ((v = u), (b = s));
              m =
                1 === q.lineWidth % 2
          ...
          if (
            ...
            for (
              ...
              if (n[s].dataPoint.y && n[s].dataPoint.y.length)
                for (z = 0; z < n[s].dataPoint.y.length; z++)
                  (u = Math.abs(
                    d - this.parent.convertValueToPixel(n[s].dataPoint.y[z])
                  )),
                    u < v && ((v = u), (x = s));
              else
                (u = Math.abs(
          ...
          if (
            ...
            for (s = u = 0; s < z.dataPoint.y.length; s++)
              (u = Math.abs(
                d - this.parent.convertValueToPixel(z.dataPoint.y[s])
              )),
                u < v && ((v = u), (b = s));
            w =
              1 === q.lineWidth % 2
