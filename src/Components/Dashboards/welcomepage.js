...
const WelcomePage = () => {
  let sample = {
    Class9: {
      Doctors: <MedicalServicesIcon />,
      Engineers: <EngineeringIcon />,
      Lawyers: <GavelIcon />,
    },
    Class10: {
      Doctors: <MedicalServicesIcon />,
          ...
          <div className="section-row">
            <div className="card-wrap">
              <div className="bg-one card">
                <div className="card-body" onClick={showHidden}>
...
export const HiddenComponent = () => {
  return (
    <>
      <section className="Hiddeen-section-wrap">
