...
export default function FilterScreen(props){
  ...
  let temp=[
    {name:"johm",class:"9th Grade",pTask:"doctor",sTask:"engineer",status:"inProgress"},
    {name:"jack",class:"9th Grade",pTask:"lawyer",sTask:"pilot",status:"inProgress"},
    {name:"jill",class:"9th Grade",pTask:"",sTask:"",status:"yet to assign"},

    {name:"johm",class:"10th Grade",pTask:"doctor",sTask:"engineer",status:"inProgress"},
    {name:"jack",class:"10th Grade",pTask:"lawyer",sTask:"pilot",status:"inProgress"},
    {name:"jill",class:"10th Grade",pTask:"scientist",sTask:"politician",status:"inProgress"},
    
    {name:"nancy",class:"11th Grade",pTask:"police",sTask:"pilot",status:"inProgress"},
    {name:"mani",class:"11th Grade",pTask:"engineer",sTask:"pilot",status:"inProgress"},
    {name:"arun",class:"11th Grade",pTask:"chef",sTask:"business",status:"inProgress"},

    {name:"jude",class:"12th Grade",pTask:"engineer",sTask:"Pilot",status:"completed"},
    {name:"peter",class:"12th Grade",pTask:"farmer",sTask:"Pilot",status:"inProgress"},
    {name:"hari",class:"12th Grade",pTask:"lawyer",sTask:"Pilot",status:"inProgress"},
  ]
